...
async function processGamepassPurchase(transaction: any) {
  try {
    ...
    // Prioritaskan akun Robux Plus terlebih dahulu
...
export async function PUT(
  ...
  try {
    ...
    console.log("serviceCategory:", transaction.serviceCategory);
    console.log("transaction.gamepass:", JSON.stringify(transaction.gamepass));
    console.log(
      "transaction.rbx5Details?.gamepass:",
      JSON.stringify(transaction.rbx5Details?.gamepass),
    );
    console.log("hasValidGamepass:", hasValidGamepass);
