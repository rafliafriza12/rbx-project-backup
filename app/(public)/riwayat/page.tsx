                    ...
                    <div className="flex flex-col sm:items-end gap-3">
                      <div className="text-right relative">
                        ...
                        {(transaction.discountPercentage || 0) > 0 && (
                          <div className="text-sm text-primary-200/60 mb-1">
                            <span className="line-through">
                              Rp{" "}
                              {transaction.totalAmount.toLocaleString("id-ID")}
                            </span>
                            <span className="ml-2 text-green-400 font-medium bg-green-400/20 px-2 py-0.5 rounded-full border border-green-400/30">
